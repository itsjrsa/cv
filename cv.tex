...
\begin{myitemize}	
	\item \textit{\textbf{InteGrid} - Demonstration of INTElligent grid technologies for renewables INTEgration and INTEractive consumer participation enabling INTEroperable market solutions and INTErconnected stakeholders}
		...
		\begin{itemize}[itemsep=1px]
		\item Design and implementation of forecasting system centralized database and RESTful API's
		\item Exploration and exploitation of multiple short-term (up to 48 hours ahead) forecasting algorithms for load, renewable energy sources (wind/solar), and Iberian Electricity Market (MIBEL) energy prices
		\item Participation on the development of weather data acquisition (measurements and numerical weather predictions) from multiple weather providers
		\item Demonstration of forecasting system(s) in real operational environments
		\item Paper publication(s) on international peer-reviewed journal
		\end{itemize}
	...
	\item \textit{\textbf{CORAL} - Sustainable Ocean Exploitation: Tools and Sensors}
		...
		\begin{itemize}[itemsep=1px]
			...
			\item Paper publication on international peer-reviewed journal
		\end{itemize}
